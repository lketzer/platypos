...
* **supplementary_files**: Contains some extra files for plotting; 
                           Tu et al. (2015)<sup>[4](#Tu-et-al-15)</sup> <br> model tracks for the X-ray luminosity evolution, 
                           Jackson et al. (2012)<sup>[10](#Jackson-et-al-12)</sup> <br> sample of X-ray measurements in young clusters)
...
<a name="Chen-Kipping-2017">8</a>: [Chen & Kipping 2017](https://arxiv.org/abs/1603.08614) <br>
<a name="Otegi-et-al-2020">9</a>: [Otegi et al. 2020](https://arxiv.org/abs/1911.04745) <br>
